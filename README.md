...
Full documentation is available at **[https://f5xc-salesdemos.github.io/administration/](https://f5xc-salesdemos.github.io/administration/)**.

## Getting Started

```bash
git clone https://github.com/f5xc-salesdemos/administration.git
```

See the [documentation](https://f5xc-salesdemos.github.io/administration/) for detailed setup
and usage guides.
